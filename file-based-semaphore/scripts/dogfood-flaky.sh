...
echo "🔬 Dogfooding: Using Test Flakiness Detector to validate file-based-semaphore tests"
echo ""
...
if [ "$FAILED_RUNS" = "0" ]; then
    ...
    echo "   - All 46 tests are deterministic"
    echo "   - No race conditions in concurrent tests"
    echo "   - Lock file operations are reliable"
    echo "   - Stale detection is consistent"
